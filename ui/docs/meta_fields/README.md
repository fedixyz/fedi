...
The following meta fields are interpretable by the Fedi app to provide additional functionality that affects the user experience. Fedi-specific fields use the `fedi:` prefix unless a field is explicitly documented as an unprefixed compatibility field.
...
* [`federation_expiry_timestamp`](federation_expiry_timestamp.md): Unprefixed Fedimint federation expiry timestamp treated like `fedi:popup_end_timestamp`
