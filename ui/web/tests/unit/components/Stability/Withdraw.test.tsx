...
import { StabilityWithdraw } from '@fedi/web/src/components/Stability/Withdraw'
...
describe('/components/Stability/Withdraw', () => {
    ...
    const renderComponent = () => {
        ...
        return renderWithProviders(<StabilityWithdraw />, {
            fedimint,
            preloadedState: {
                currency: {
                    ...state.currency,
